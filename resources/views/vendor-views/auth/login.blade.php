...
<main id="content" role="main" class="main">
    ...
    @php($systemlogo=\App\Models\BusinessSetting::where(['key'=>'logo'])->first() ?: null)
    <!-- Content -->
    <div class="container py-5 py-sm-7">
        <a class="d-flex justify-content-center mb-5" href="javascript:">
            <img class="z-index-2"
            onerror="this.src='{{asset('assets/admin/img/160x160/img2.jpg')}}'"
                         src="{{asset('storage/app/business/'.$systemlogo)}}"
                    ...
                    <div class="card-body">
                        ...
                        <form class="js-validate" action="{{route('vendor.auth.employee.login')}}" method="post" id="employee_login_form" style="display: none;">
                            ...
                            <div class="js-form-message form-group">
                                ...
                                <div class="input-group input-group-merge">
                                    <input type="password" class="js-toggle-password form-control form-control-lg"
                                           name="password"  placeholder="5+ characters required"
                                           aria-label="8+ characters required" required
                                           data-msg="Your password is invalid. Please try again."
                                           data-hs-toggle-password-options='{
                                                     "target": "#changePassTarget",
