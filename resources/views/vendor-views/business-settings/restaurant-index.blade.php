                                ...
                                <div class="col-sm-6 col-12">
                                    <div class="form-group p-2 border">
                                        <label class="d-flex justify-content-between switch toggle-switch-sm text-dark" for="gst_status">
                                            <span>{{__('messages.gst')}} <span class="input-label-secondary" title="{{__('messages.gst_status_warning')}}"><img src="{{asset('/assets/admin/img/info-circle.svg')}}" alt="{{__('messages.gst_status_warning')}}"></span></span>
