        ...
        <div class="navbar-vertical-container">
            ...
            <div class="navbar-vertical-content" style="background-color: #334257;">
                <ul class="navbar-nav navbar-nav-lg nav-tabs">
                    ...
                    <!-- End Banner -->
                    <!-- Sliders -->
                    @if (\App\CentralLogics\Helpers::module_permission_check('sliders'))
                        <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/sliders*') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                                href="{{ route('admin.sliders.add-new') }}" title="{{ __('messages.slider') }}">
                                <i class="tio-photo-gallery nav-icon"></i>
                                <span
                                    class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{ __('messages.sliders') }}</span>
                            </a>
                        </li>
                    @endif
                    <!-- End Sliders -->
