                            ...
                            <div class="row justify-content-md-center">
                                <div class="col-xl-4 col-md-4 col-sm-6 col-6">
                                    <div class="form-group">
                                        ...
                                        <span class="pr-2">{{__('messages.food_section')}}<span class="input-label-secondary" title="{{__('messages.show_hide_food_menu')}}"><img src="{{asset('/assets/admin/img/info-circle.svg')}}" alt="{{__('messages.show_hide_food_menu')}}"></span> :</span> 
                                ...
                                <div class="col-xl-4 col-md-4 col-sm-6 col-6">
                                    <div class="form-group">
                                        ...
                                        <span class="pr-2">{{__('messages.reviews')}} {{__('messages.panel')}}<span class="input-label-secondary" title="{{__('messages.show_hide_reviews_menu')}}"><img src="{{asset('/assets/admin/img/info-circle.svg')}}" alt="{{__('messages.show_hide_food_menu')}}"></span> :</span> 
                                    ...
                                    <div class="col-6"> 
                                        <div class="form-group p-2 border">
                                            <label class="d-flex justify-content-between switch toggle-switch-sm text-dark" for="comission_status">
                                                <span>{{__('messages.admin_commission')}}(%) <span class="input-label-secondary" title="{{__('messages.if_sales_commission_disabled_system_default_will_be_applicable')}}"><img src="{{asset('/assets/admin/img/info-circle.svg')}}" alt="{{__('messages.if_sales_commission_disabled_system_default_will_be_applicable')}}"></span></span>
