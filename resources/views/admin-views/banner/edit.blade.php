                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title" class="form-control" placeholder="New banner" value="{{$banner->title}}" required>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group" id="item_wise">
                                        ...
                                        <select name="item_id" id="choice_item" class="form-control js-select2-custom" placeholder="Select Food">
