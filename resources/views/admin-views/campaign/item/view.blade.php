            ...
            <div class="card-body">
                <div class="row align-items-md-center gx-md-5">
                    ...
                    <div class="col-sm-5">
                        ...
                        <small class="text-dark">
                            {{__('messages.available')}} {{__('messages.time')}} {{__('messages.starts')}} : {{$campaign->start_time->format('h:i:s A')}}
                        </small><br>
                        <small class="text-dark">
                            {{__('messages.available')}} {{__('messages.time')}} {{__('messages.ends')}} : {{$campaign->end_time->format('h:i:s A')}}
                        </small>
                    </div>
