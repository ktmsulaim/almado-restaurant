                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="title" class="form-control" placeholder="New campaign" required>
                            </div>
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <textarea type="text" name="description" class="form-control" placeholder="About the campaign..." maxlength="255"></textarea>
                            </div>
                            <div class="form-group">
