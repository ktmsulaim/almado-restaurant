                            ...
                            <div class="form-group" id="restaurant_wise" style="display: {{$coupon['coupon_type']=='restaurant_wise'?'block':'none'}}">
                                ...
                                <div class="form-group" id="zone_wise" style="display: {{$coupon['coupon_type']=='zone_wise'?'block':'none'}}">
                                    ...
                                    <select name="zone_ids[]" id="choice_zones"
                                        ...
                                        multiple="multiple" placeholder="Select Zone">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 col-6">
                            <div class="form-group">
                                ...
                                <input type="date" name="start_date" class="form-control" id="date_from" placeholder="Select date" value="{{date('Y-m-d',strtotime($coupon['start_date']))}}">
                            </div>
                        </div>
                        <div class="col-md-3 col-6">
                            <div class="form-group">
                                <label class="input-label" for="date_to">{{__('messages.expire')}} {{__('messages.date')}}</label>
                                <input type="date" name="expire_date" class="form-control" placeholder="Select date" id="date_to" value="{{date('Y-m-d',strtotime($coupon['expire_date']))}}"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 col-6">
                            <div class="form-group">
                                ...
                                <input type="number" id="discount" min="1" max="{{$coupon['discount_type']=='percent'?'100':'1000000'}}" step="0.01" value="{{$coupon['discount']}}"
                        ...
                        <div class="col-md-3 col-6">
                            <div class="form-group">
                                ...
                                <input type="number" min="0" max="1000000" step="0.01"
                                       value="{{$coupon['max_discount']}}" name="max_discount" id="max_discount" class="form-control" {{$coupon['discount_type']=='amount'?'readonly':''}}>
                            </div>
                        </div>
                        <div class="col-md-3 col-6">
                            <div class="form-group">
                                <label class="input-label" for="exampleFormControlInput1">{{__('messages.min')}} {{__('messages.purchase')}}</label>
                                <input type="number" name="min_purchase" step="0.01" value="{{$coupon['min_purchase']}}" id="min_purchase"
                                       min="{{$coupon['discount_type']=='amount'?$coupon['discount']:'0'}}" max="100000" class="form-control"
                                       placeholder="100">
                            </div>
                        </div>
                    </div>
         ...
         if($('#discount_type').val() == 'amount')
            {
                ...
                $('#min_purchase').attr("min",$('#discount').val());
            }
            else
            {
                $('#max_discount').removeAttr("readonly");
                $('#discount').attr("max",100);
                $('#min_purchase').attr("min",0);
            }
        });
