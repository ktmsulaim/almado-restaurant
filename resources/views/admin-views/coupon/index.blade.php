                            ...
                            <div class="row">
                                ...
                                <div class="col-4" >
                                    <div class="form-group" id="restaurant_wise">
                                        ...
                                        <select name="restaurant_ids[]" class="js-data-example-ajax form-control" data-placeholder="Select Restaurant" title="Select Restaurant">                                            
                                        </select>
                                    </div>
                                    <div class="form-group" id="zone_wise">
                                        ...
                                        <select name="zone_ids[]" id="choice_zones"
                                            ...
                                            multiple="multiple" data-placeholder="Select Zone">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="0.01" name="min_purchase" id="min_purchase" value="0" min="0" max="100000" class="form-control"
                                            placeholder="100">
                                    </div>
                                </div>                                
                            </div>
