                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-12">
                            ...
                            <div class="form-group">
                                ...
                                <span class="input-label-secondary" title="{{__('messages.order_confirmation_model_hint')}}"><img src="{{asset('/assets/admin/img/info-circle.svg')}}"></span>
                                 *</small>
                                <div class="input-group input-group-md-down-break">
                                    <!-- Custom Radio -->
                                    <div class="form-control">
                        ...
                        <div class="col-md-4 col-12">
                            ...
                            <div class="form-group">
                                <label class="input-label d-inline">{{__('messages.customer')}} {{__('messages.verification')}}</label><small style="color: red"><span
                                        class="input-label-secondary" title="{{__('messages.customer_varification_toggle')}}"><img src="{{asset('/assets/admin/img/info-circle.svg')}}" alt="{{__('messages.customer_varification_toggle')}}"></span> *</small>
                                <div class="input-group input-group-md-down-break">
                                    <!-- Custom Radio -->
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                        ...
                        <div class="col-md-4 col-12">
                            ...
                            <div class="form-group">
                                <label class="input-label d-inline">{{__('messages.order')}} {{__('messages.delivery')}} {{__('messages.verification')}}</label><small style="color: red"><span
                                        class="input-label-secondary" title="{{__('messages.order_varification_toggle')}}"><img src="{{asset('/assets/admin/img/info-circle.svg')}}" alt="{{__('messages.order_varification_toggle')}}"></span> *</small>
                                <div class="input-group input-group-md-down-break">
                                    <!-- Custom Radio -->
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                        ...
                        @php($dm_maximum_orders=\App\Models\BusinessSetting::where('key','dm_maximum_orders')->first())
                            <div class="form-group">
                                <label class="input-label d-inline text-capitalize" for="dm_maximum_orders">{{__('messages.dm_maximum_order')}}</label><small style="color: red"><span
                                        class="input-label-secondary" title="{{__('messages.dm_maximum_order_hint')}}"><img src="{{asset('/assets/admin/img/info-circle.svg')}}" alt="{{__('messages.dm_maximum_order_hint')}}"></span> *</small>
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                <label class="input-label text-capitalize d-inline" for="latitude">{{__('messages.latitude')}}<span
                                        class="input-label-secondary" title="{{__('messages.click_on_the_map_select_your_defaul_location')}}"><img src="{{asset('/assets/admin/img/info-circle.svg')}}" alt="{{__('messages.click_on_the_map_select_your_defaul_location')}}"></span></label>    
